...
<html>
    <head>
        ...
        <title>Dees Desert</title>
          ...
          <script>
              ...
              var e=$('#sess').val();
              $.get("GetProfile?emailid="+e,function(data, status){
    ...
    <body>
        <input type="hidden" id="sess" value="<%=session.getAttribute("A1")%>"></input>
      <%
        ...
        <div class="row"  >
         <div class="col-md-4 col-md-offset-4" >
             ...
             <div class="panel panel-danger" >
                  ...
                  <form role="form" name="frmeditprofile" id="frmeditprofile" action="EditProfile" method="post">
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-info" id="register" style=";font-weight: bolder;">Save changes</button>
                    </div>
              </form>                            
            </div>
             </div>
