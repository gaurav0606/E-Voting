         ...
         <div class="col-md-4 col-md-offset-4" >
           ${errormsg}
             <legend style="border-bottom:2px solid">Enter OTP value</legend>
                  <form role="form" name="frmsignup1" id="frmsignup1" action="Signup1" method="post"  >
                    ...
                    <div class="form-group ">
                        <button type="submit"  class="btn btn-default"  ${disabled} style="background-color: #333333;color:white"  >Submit</button>
                    </div>
              </form>                            
            </div>
    </div>
