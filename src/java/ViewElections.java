...
public class ViewElections extends HttpServlet
{
    public void doGet(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
    {
        ...
        Connection con=DB_Connection.get_DBConnection();
            ...
            PreparedStatement pst2=con.prepareStatement("select * from election");
            ...
            if(rs1.next())
            {
                ...
                t=t+"<td style='padding-left:40px'>"+"<a href='editelection.jsp?ecode="+rs1.getString(1)+"'  type='button' class='fa fa-edit' style='cursor:pointer;border:none;font-size:20px;color:blue;background-color: #d9edf7;'></i></a>";
